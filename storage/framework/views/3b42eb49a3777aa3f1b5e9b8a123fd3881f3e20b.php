...
<head>
    ...
    <link href="<?php echo e(asset('black')); ?>/demo/demo.css" rel="stylesheet" />
</head>
...
<body class=" rtl menu-on-right ">
            ...
            <ul class="navbar-nav  mr-auto">
              ...
              <li class="dropdown nav-item">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <div class="photo">
                    <img src="<?php echo e(asset('black')); ?>/img/anime3.png" alt="Profile Photo">
                  </div>
  ...
  <script src="<?php echo e(asset('black')); ?>/demo/demo.js"></script>
  <script>
...
</html><?php /**PATH /app/scripts/laravel-teste/projeto-cartola/resources/views/pages/rtl.blade.php ENDPATH**/ ?>